# This is the top level tcl file for 'fft_example_DUT'
...
if {!$overwrite_opt && [project_exists fft_example_DUT]} {
    puts "The fft_example_DUT quartus project already exists."
    puts "Use 'overwrite option' to force project to be over-written/"
} elseif {![file exists "./rtl/fft_example/fft_example_DUT.tcl"]}    {
    puts "You must run fft_example_DUT.tcl "
...
puts "Creating fft_example_DUT Quartus project..."

if $overwrite_opt {
    project_new -overwrite fft_example_DUT
} else {
    project_new fft_example_DUT
}

set_global_assignment -name FAMILY "Agilex 7"
set_global_assignment -name TOP_LEVEL_ENTITY fft_example_DUT
set_global_assignment -name DEVICE AGFB014R24A1E1V
set_global_assignment -name USE_TIMEQUEST_TIMING_ANALYZER ON
set_global_assignment -name SDC_FILE ./rtl/fft_example/fft_example_DUT.sdc
set_global_assignment -name SYNCHRONIZATION_REGISTER_CHAIN_LENGTH 1
set_global_assignment -name FLOW_DISABLE_ASSEMBLER ON
source ./rtl/fft_example/fft_example_DUT.add.tcl
...
source "./rtl/fft_example/fft_example_DUT_fpc.add.tcl"
