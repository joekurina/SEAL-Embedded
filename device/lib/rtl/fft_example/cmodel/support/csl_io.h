...
inline void fmt_error(const char* msg, ...)
{
    char buffer[1024];
    va_list args;
    va_start(args, msg);
...
inline void fmt_warning(const char* msg, ...)
{
    char buffer[1024];
    va_list args;
    va_start(args, msg);
...
inline void fmt_info(const char* msg, ...)
{
    char buffer[1024];
    va_list args;
    va_start(args, msg);
 ...
 */
std::string to_binary(uint64_t a, unsigned width);
/**
...
private:
#ifdef CSL_USE_GMP
    mp_int m_mask = int64_t(0xFFFFFFFFll);
#endif
    mp_int_temps m_temps;
...
public:
    ...
    stimulus_file(const std::string& fileName, StimulusFormat format);
...
class dump_file
{
    static constexpr int32_t ID_ROWS = 0x524F5753;
    static constexpr int32_t ID_DUMP = 0x44554D50;
    static constexpr int32_t ID_LOCS = 0x4C4F4353;
    static constexpr int32_t ID_SEGS = 0x53454753;
    static constexpr int32_t ID_STEP = 0x53544550;
    static constexpr int32_t ID_DATA = 0x44415441;
    static constexpr int32_t ID_CYCL = 0x4359434C;
...
public:
    ...
    void set_location_info(size_t location, int bit_width, const char* name);
    /** Sets current cycle for assistance in debugging */
    void set_current_cycle(int64_t value);

    /** Opens a dump file for output */
    void add_row(int64_t* nativeData, size_t nativeCount, mp_int* wideData, size_t wideCount, const char* step_name);
...
/**
 * csl_io_def.h contains the implementation details for the functions
 * defined in this header.
 */
#include "csl_io_def.h"
