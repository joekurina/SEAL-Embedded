...
public:
    // Constructor accepting the number of elements and result buffer
    ...
    void operator()(sycl::handler& h) const {
        ...
        h.single_task([=]() [[intel::kernel_args_restrict]] {
            ...
            for (size_t i = 0; i < num_structs; ++i) {
                // Read from NTT B output pipe
                bool output_valid = false;
                NTT_RTL_Output_Data rtl_output = NTTBOutputPipe::read(output_valid);
