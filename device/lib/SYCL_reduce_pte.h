...
public:
    ...
    void operator()(sycl::handler& h) const {
        ...
        sycl::ext::oneapi::experimental::printf("ReduceSetPTEKernel: Starting...\n");

        h.single_task([=]() [[intel::kernel_args_restrict]] {
            sycl::ext::oneapi::experimental::printf("ReduceSetPTEKernel: Started...\n");

            sycl::ext::oneapi::experimental::printf("ReduceSetPTEKernel: Kernel check const_ratio[0]=%u\n", kernel_const_ratio[0]);

            // Process each coefficient
            for (size_t i = 0; i < kernel_n; i++) {
                // Read input value from the pipe:
                sycl::ext::oneapi::experimental::printf("ReduceSetPTEKernel: Blocking Read From Pipe...\n");
