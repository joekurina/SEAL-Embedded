...
// Helper function to get inverse of n
static ZZ get_n_inverse(size_t n, ZZ q) {
    // Add lookup table similar to get_intt_root
    ZZ inv_n;
    switch(n) {
        case 4096:
            switch(q) {
                case 134012929: inv_n = 133980211; break;
                case 134111233: inv_n = 134078491; break;
                // Add more cases as needed
                default: exit(1);
            }
            break;
        // Add more n cases as needed
        default: exit(1);
    }
    return inv_n;
}
