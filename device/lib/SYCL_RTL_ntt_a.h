...
public:
    RTLNTTKernel_A(uint32_t mod_val, uint8_t mod_selector) : mod_value(mod_val), modulus_selector(mod_selector) {}
    ...
    void operator()(sycl::handler& h) const {
        ...
        h.single_task<RTLNTTKernel_A>([=]() [[intel::kernel_args_restrict]] {
            ...
            sycl::ext::oneapi::experimental::printf("NTTKernel_A: Processing modulus selector %u\n", kernel_mod_selector);
