...
public:
    // Constructor accepting the number of elements and modulus
    ...
    void operator()(sycl::handler& h) const {
        ...
        h.single_task([=]() [[intel::kernel_args_restrict]] {
            ...
            for (size_t i = 0; i < kernel_n; ++i) {
                // Read from the existing ScaleReduceToNTTBPipe
                bool read_success = false;
                uint32_t pipe_element = ScaleReduceToNTTBPipe::read(read_success);
